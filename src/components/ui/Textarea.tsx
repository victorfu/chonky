    ...
    return (
      <div className="w-full space-y-2">
        ...
        <textarea
          ref={textareaRef}
          className={cn(
            'flex min-h-[60px] w-full resize-none rounded-[6px] border border-border-hairline bg-background-elevated/72 px-3 py-2 text-sm shadow-sm transition-colors motion-safe:duration-200 placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50',
