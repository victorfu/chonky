      ...
      <div className={cn('w-full space-y-2', containerClassName)}>
        ...
        <div className="relative">
          ...
          <input
            ref={ref}
            className={cn(
              'flex h-9 w-full rounded-[6px] border border-border-hairline bg-background-elevated/72 px-3 py-1 text-sm shadow-sm transition-colors motion-safe:duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50',
              leftIcon && 'pl-10',
              rightIcon && 'pr-10',
